...
//
//     final getCateogoryModel = getCateogoryModelFromJson(jsonString);

import 'dart:convert';

GetCateogoryModel getCateogoryModelFromJson(String str) =>
    GetCateogoryModel.fromJson(json.decode(str));

String getCateogoryModelToJson(GetCateogoryModel data) =>
    json.encode(data.toJson());

class GetCateogoryModel {
  bool status;
  String message;
  Data data;
  ...
  factory GetCateogoryModel.fromJson(Map<String, dynamic> json) =>
      GetCateogoryModel(
        status: json["status"],
